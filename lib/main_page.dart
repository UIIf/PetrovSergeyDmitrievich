                        ...
                        children: [
                          ...
                          TextButton(
                              ...
                              child: Text("BACK",
                                  style: TextStyle(
                                      color:
                                          Color.fromARGB(255, 240, 40, 100)))),
                          TextButton(
                              onPressed: () => context.router.push(const SettingsRoute()),
                              child: Text("SETTINGS", style: TextStyle(color:Color.fromARGB(255, 240, 40, 100)))
                          ),
                          TextButton(
                              onPressed: () =>
                              context.router.push(const FeedRoute()),
                          child: Text("FEED", style: TextStyle(color:Color.fromARGB(255, 240, 40, 100)),)),
                        ],
                      )
                    ]),
              ],
